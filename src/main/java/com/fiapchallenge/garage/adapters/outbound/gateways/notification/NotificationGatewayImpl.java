package com.fiapchallenge.garage.adapters.outbound.gateways.notification;
...
public class NotificationGatewayImpl implements NotificationGateway {
    ...
    public NotificationGatewayImpl(JpaNotificationRepository jpaNotificationRepository) {
