package com.fiapchallenge.garage.adapters.outbound.gateways.customer;
...
public class CustomerGatewayImpl implements CustomerGateway {
    ...
    public CustomerGatewayImpl(JpaCustomerRepository jpaCustomerRepository) {
    ...
    public Optional<Customer> findById(UUID id) {
        return jpaCustomerRepository.findById(id).map(this::convertFromEntity);
    }
