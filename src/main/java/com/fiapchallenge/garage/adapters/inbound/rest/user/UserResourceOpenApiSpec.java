...
public interface UserResourceOpenApiSpec {
    ...
    @Operation(summary = "Criar um novo usuario", description = "Cria um novo usuario com os dados fornecidos. Autenticação via POST /login (CPF) ou POST /admin/login (email/password) no API Gateway.")
    @ApiResponses(value = {
